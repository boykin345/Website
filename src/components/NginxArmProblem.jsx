        ...
        <>
            ...
            <section className="blog-container">
                ...
                <div className="code-container">
                    <p className="about-text">This issue goes from Apple implementing ARM chips in their somewhat new
                        Macbooks.
                        This issue is especially critical all web developers working with big corporate projects(such as
                        me)\n
